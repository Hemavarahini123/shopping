...
<div class="row">
		<div class="col-lg-12">
          ...
          <div align="center">
				...
				if($catid!="")
				{
				$qry=mysqli_query($connect,"select * from product where catid=$catid");
				}
				else
				{
		  ...
		  <table width="45%" class="table table-bordered">
				<thead>
				  <tr>
					...
					<th width="5%" class="bg-info">Category</th>
				...
				?>
				  <tr>
					...
					<th width="15%" class="bg-info2"><?php  echo '<a href="change.php?pid='.$row['id'].'"><img src="product/'.$pn.'" width="60" height="60"></a>'; ?></th>
					<td class="bg-info2"><?php echo $row['catid']; ?></td>
					<th width="13%" class="bg-info2"><?php echo $row['product']; ?></th>
					<th width="15%" class="bg-info2"><?php echo $row['price']; ?></th>
					<th width="15%" class="bg-info2"><?php echo $row['quantity']; ?></th>
					<th width="15%" class="bg-info2"><?php echo $row['description']; ?></th>
					<th width="15%" class="bg-info2"><a href="edit.php?pid=<?php echo $row['id']; ?>">Edit</a> | <a href="view_product.php?act=del&did=<?php echo $row['id']; ?>">Delete</a></th>
				  </tr>
				  <?php
				  }
				  ?>
