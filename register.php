...
<!--                		<div class="form-group">
                      ...
                      <input type="text" name="refer" placeholder="Referred Username" class="form-control">
                    </div> -->
<!-- 					<div class="form-group">
                      <label>Refer by</label>
                      <select name="shop">
                    ...
                    <?php
		  $sq=mysqli_query($connect,"select * from reg_shop");
		  while($sr=mysqli_fetch_array($sq))
		  {
		  ?>
                    <option value="<?php echo $sr['uname']; ?>" <?php if($shop==$sr['uname']) echo "selected"; ?>><?php echo $sr['name']." (".$sr['uname'].")"; ?></option>
                    <?php
		  }
		  ?>
                  </select>
					...
					<div class="form-group">
                      ...
                      <input type="text" name="credit" placeholder="Card No." class="form-control">
                    </div>
					<div class="form-group">
...
<div class="row">
 ...
 $msg="";
	 ...
	 ////////
	 $rq1=mysqli_query($connect,"select * from register where username='$refer'");
	 $rn1=mysqli_num_rows($rq1);
	 if($rn1>0)
	 {
	 $qq1=mysqli_query($connect,"select * from creditpoint");
	$rr1=mysqli_fetch_array($qq1);
	$ca=$rr1['creditamt'];
	$cp=$rr1['creditrate'];
	$cm=$rr1['creditmax'];
	mysqli_query($connect,"update credit_shop set creditamt=creditamt+$ca,creditpoint=creditpoint+$cp where uname='$refer' && shop='$shop'");
	}
	//////
	 
	
	 $ins=mysqli_query($connect,"insert into register(id,name,address,pincode,contact,email,credit,refer,shop,username,password,rdate) values($id,'$name','$address','$pincode','$mobile','$email','$credit','','','$uname','$pass','$rdate')");
