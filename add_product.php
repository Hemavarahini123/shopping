                ...
                <div class="card-block">
                  ...
                  <form name="name" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
					  ...
					  <?php
					  $cq=mysqli_query($connect,"select * from category where shop='$uname'");
                   ...
                   <div class="form-group">
					...
					<div class="form-group">
                      <label>GST %</label>
                      <input type="text" name="gst" placeholder="GST %" class="form-control">
                    </div>
...
<div class="row">
 ...
 $msg="";
	 ...
	 $ins=mysqli_query($connect,"insert into product(id,shop,catid,product,price,quantity,description,gst) values($id,'$uname',$catid,'$product',$price,$quantity,'$description','$gst')");
