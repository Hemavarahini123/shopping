...
if($act=="del")
{
mysqli_query($connect,"delete from reg_shop where id=$did");
?>
...
<div class="row">
		<div class="col-lg-12">
				...
				$qry=mysqli_query($connect,"select * from reg_shop");
		  ...
		  <table width="45%" class="table table-bordered">
				...
				?>
				  <tr>
					...
					<th width="15%" class="bg-info2"><?php echo '<a href="view_shop.php?act=del&did='.$row['id'].'">Delete</a>'; ?></th>
				  </tr>
				  <?php
				  }
				  ?>
