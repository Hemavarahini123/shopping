...
$q1=mysqli_query($connect,"select * from creditpoint where id=1");


if(isset($btn))
{
mysqli_query($connect,"update creditpoint set creditamt='$creditamt',creditrate='$creditrate',creditmax='$creditmax' where id=1");
?>
...
if($act=="del")
{
mysqli_query($connect,"delete from register where id=$did");
?>
<script language="javascript">
window.location.href="view_cus.php";
</script>
		  ...
		  <table width="45%" class="table table-bordered">
				...
				?>
				  <tr>
					...
					<th width="13%" class="bg-info2"><?php echo $row['username']; ?></th>
					<th width="13%" class="bg-info2"><?php echo $row['name']; ?></th>
					<th width="15%" class="bg-info2"><?php echo $row['contact']; ?></th>
					<th width="15%" class="bg-info2"><?php echo $row['email']; ?></th>
					<th width="15%" class="bg-info2"><?php echo '<a href="view_cus.php?act=del&did='.$row['id'].'">Delete</a>'; ?></th>
				  </tr>
				  <?php
				  }
				  ?>
