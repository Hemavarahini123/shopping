			...
			<div class="col-lg-4">
			 ...
			 <?php
				...
				<div class="alert alert-success">
				  <strong>Register Success!</strong> <a href="login.php">Login</a>
				</div>
				<?php
				}
...
<div class="row">
 ...
 $msg="";
	 ...
	 $mq=mysqli_query($connect,"select max(id) from reg_shop");
	 $mr=mysqli_fetch_array($mq);
	 $id=$mr['max(id)']+1;
	 
	  if($_FILES['file']['name'])
	 {
	$filename="S".$id.$_FILES['file']['name'];
	move_uploaded_file($_FILES['file']['tmp_name'],"upload/".$filename);
	}
	 
	
	 $ins=mysqli_query($connect,"insert into reg_shop(id,name,contact,email,filename,uname,pass,rdate) values($id,'$name','$mobile','$email','$filename','$uname','$pass','$rdate')");
	 ...
	 <?php
		...
		else
		{
		 ?>
	 <script language="javascript">
	 window.location.href="reg_shop.php?act=wrong";
	 </script>
	 <?php
		}
	 }
